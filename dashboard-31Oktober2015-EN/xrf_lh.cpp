...
/* by ik5xmk  */
 ...
 /* end block */
   ...
   if ( strcmp(argv[5], "YES") == 0 ) // e' richiesta la visualizzazione delle informazioni di sistema
   {
     ...
     printf("<br>Refresh-Time: 60secs.", argv[7]);
   ...
   printf("<div id=\"num1\">\n");
   printf("<h3 id=\"tabletitle\">Links Reflector/Repeater/UP4DAR</h3>\n");
   printf("<table class=\"gateways\">\n");
   printf("<tr>\n");
   printf("<th>#</th><th>Module (A)</th><th>Module (B)</th><th>Module (C)</th><th>Module (D)</th><th>Echo Test (E)</th>\n");
   printf("</tr>\n");
   ...
   printf("<div id=\"num2\">\n");
   printf("<h3 id=\"tabletitle\">Links Hotspot</h3>\n");
   printf("<table class=\"clients\">\n");
   printf("<tr>\n");
   printf("<th>#</th><th>Callsign</th><th>Status</th><th>Typ</th>\n");
   printf("</tr>\n");
   ...
   printf("<div id=\"num3\">\n");
   printf("<h3 id=\"tabletitle\">Last Heard</h3>\n");
   printf("<table class=\"calls\">\n");
   printf("<tr>\n");
   printf("<th>#</th><th>Callsign</th><th>Source</th><th>Date-Time</th>\n");
   printf("</tr>\n");
